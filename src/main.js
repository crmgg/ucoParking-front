...
import { initTabAuthSession, hasTabAuth } from './services/tabAuthSession'
import { httpDemoMode, HTTP_DEMO_KEY } from './config/httpDemo'
...
if (httpDemoMode) {
  app.provide(HTTP_DEMO_KEY, true)
  router.beforeEach((to) => {
    if (to.meta.requiresAuth && !hasTabAuth()) {
      return { name: 'login' }
    }
    return true
  })
